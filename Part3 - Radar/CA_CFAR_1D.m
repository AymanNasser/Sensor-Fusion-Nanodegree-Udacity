...
for i = 1:(Ns-(G+T+1))     
    ...
    avgSumCells = sum(s(i:i+T-1)) / T;
    noiseThreshold = avgSumCells*offset; % Multiply or add it, based on linearity of values
    threshold_cfar = [threshold_cfar, {noiseThreshold}];
